    ...
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-5xl md:text-7xl font-light tracking-tight text-stone-900 mb-6">
          {t('hero.title.1')} <br />
          <span className="font-semibold italic">{t('hero.title.2')}</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="group bg-stone-900 text-white px-8 py-4 rounded-full text-lg font-medium transition-all hover:bg-stone-800 hover:scale-105 flex items-center justify-center gap-2"
          >
            {t('hero.rates')}
          ...
          <a
            ...
            className="bg-white/80 backdrop-blur-sm border border-stone-200 text-stone-900 px-8 py-4 rounded-full text-lg font-medium transition-all hover:bg-white hover:border-stone-300"
          >
            {t('hero.discover')}
          </a>
        </div>
