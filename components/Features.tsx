...
export const Features: React.FC = () => {
  ...
  return (
    <section id="studio" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-primary-50/30 skew-x-12 translate-x-1/2"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-sm font-semibold text-primary-600 uppercase tracking-wider mb-2">{t('features.studio')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {features.map((feature, index) => (
            <div key={index} className="group p-6 rounded-2xl bg-stone-50 hover:bg-white hover:shadow-xl hover:shadow-stone-200/50 hover:-translate-y-1 transition-all duration-300 border border-transparent hover:border-primary-100">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm mb-6 text-primary-600 group-hover:scale-110 group-hover:bg-primary-50 transition-all duration-300 ring-1 ring-stone-100 group-hover:ring-primary-100">
