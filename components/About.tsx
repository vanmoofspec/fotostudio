      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1 relative">
            <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-stone-200 relative z-10">
               <img 
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-8 -left-8 w-48 h-48 bg-stone-200/50 rounded-full blur-2xl"></div>
            <div className="absolute -top-8 -right-8 w-64 h-64 bg-stone-100 rounded-full -z-0"></div>
          </div>
          
          <div className="order-1 md:order-2">
            <h2 className="text-sm font-semibold text-stone-500 uppercase tracking-wider mb-2">{t('about.subtitle')}</h2>
            ...
            <div className="mt-8 flex gap-8">
              <div>
                <span className="block text-3xl font-medium text-stone-900">60m²</span>
                <span className="text-sm text-stone-500">{t('about.surface')}</span>
              </div>
              <div>
                <span className="block text-3xl font-medium text-stone-900">3m</span>
                <span className="text-sm text-stone-500">{t('about.height')}</span>
              </div>
              <div>
                <span className="block text-3xl font-medium text-stone-900">∞</span>
