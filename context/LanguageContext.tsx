...
const translations = {
  nl: {
    ...
    'about.p1': 'Lichtruimte is opgericht in 2024 met een simpele visie: een plek creëren waar creativiteit vrij kan stromen, zonder afleiding. Als fotografen misten we een studio in Amsterdam die zowel betaalbaar als esthetisch hoogwaardig was.',
    ...
    'chat.welcome': 'Hi! Ik ben de assistent van Lichtruimte. Heb je vragen over de studio of beschikbaarheid?',
  ...
  en: {
    ...
    'about.p1': 'Lichtruimte was founded in 2024 with a simple vision: to create a place where creativity can flow freely, without distraction. As photographers, we missed a studio in Amsterdam that was both affordable and aesthetically high-end.',
    ...
    'chat.welcome': 'Hi! I am the Lichtruimte assistant. Do you have questions about the studio or availability?',
